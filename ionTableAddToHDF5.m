...
% /atomProbeTomography/identifiedIon/1/isTracer [int8] = 0 or 1 % tracer flag
%
...
hasIsTracer = ismember('isTracer', ionTable.Properties.VariableNames);
...
for i=1:numIon
    ...
    % write isTracer flag if available
    if hasIsTracer
        h5writeatt(fileName,path,"isTracer",int8(ionTable.isTracer(i)));
    end
end

...
% ionsCreateComplexFromList crates a list of all complex ions and their
...
% The data for ions and chargeStates can be imported form the curated, 
% maintained Excel file in the toolbox via the ionsImportFromXLS
%
% ionList = ionsCreateComplexFromList(ion,chargeStates,isotopeTable)
%
% INPUT
% ions:         list of ions as a string vector ot char cell array, e.g. 
...
%               number of chargestates. Entries are true or false for the
%               chargestate
%
